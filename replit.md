...
- Visual direction: an original Gobiverse interpretation of a dark, image-led gaming storefront, following `docs/10_UI_DESIGN_SYSTEM.md`.
...
- Use dense, scan-friendly discovery patterns—prominent search, category shortcuts, large feature artwork, horizontal content rails, strong status badges, and compact cards—without copying Instant Gaming's branding, assets, text, or exact layout.

...
export default function AboutPage() {
  const organizationJsonLd = {
    ...
    url: absoluteUrl("/"),
    description:
      "Platform gaming intelligence Indonesia untuk strategi, turnamen, dan gear.",
  };
  return (
    <section className="page-hero">
      <div className="page-shell prose">
        ...
        <ul>
          ...
          <li>
            Tidak menggunakan ilustrasi, screenshot, atau aset game berlisensi tanpa izin.
          </li>
        </ul>
        <h2>Kontak dan takedown</h2>
        <p>
          Untuk pertanyaan editorial atau permintaan takedown, hubungi{" "}
          <a href="mailto:hello@gobiverse.com">hello@gobiverse.com</a>. Detail kontak ini
          adalah jalur foundation dan akan diverifikasi sebelum produksi.
        </p>
      </div>
    </section>
  );
